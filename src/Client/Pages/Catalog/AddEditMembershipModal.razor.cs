...
{
    public partial class AddEditMembershipModal
    {
        [Inject] private IMembershipManager MembershipManager { get; set; }

        [Parameter] public AddEditMembershipCommand AddEditMembershipModel { get; set; } = new();
        ...
        {
            var response = await MembershipManager.SaveAsync(AddEditMembershipModel);
