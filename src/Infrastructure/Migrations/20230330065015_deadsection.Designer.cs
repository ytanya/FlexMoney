...
namespace FlexMoney.Infrastructure.Migrations
{
    ...
    [Migration("20230330065015_deadsection")]
    partial class deadsection
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FlexMoney.Application.Models.Chat.ChatHistory<FlexMoney.Infrastructure.Models.Identity.BlazorHeroUser>", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("FlexMoney.Domain.Entities.Catalog.Brand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FlexMoney.Domain.Entities.Catalog.Status", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FlexMoney.Domain.Entities.Misc.Document", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FlexMoney.Domain.Entities.Misc.DocumentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FlexMoney.Infrastructure.Models.Identity.BlazorHeroRole", b =>
                {
            ...
            modelBuilder.Entity("FlexMoney.Infrastructure.Models.Identity.BlazorHeroRoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FlexMoney.Infrastructure.Models.Identity.BlazorHeroUser", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("FlexMoney.Application.Models.Chat.ChatHistory<FlexMoney.Infrastructure.Models.Identity.BlazorHeroUser>", b =>
                {
                    b.HasOne("FlexMoney.Infrastructure.Models.Identity.BlazorHeroUser", "FromUser")
                        .WithMany("ChatHistoryFromUsers")
                        .HasForeignKey("FromUserId");

                    b.HasOne("FlexMoney.Infrastructure.Models.Identity.BlazorHeroUser", "ToUser")
            ...
            modelBuilder.Entity("FlexMoney.Domain.Entities.Catalog.MemberLine", b =>
                {
                    b.HasOne("FlexMoney.Domain.Entities.Catalog.MoneyLine", "Line")
                        .WithMany()
            ...
            modelBuilder.Entity("FlexMoney.Domain.Entities.Catalog.Transaction", b =>
                {
                    b.HasOne("FlexMoney.Domain.Entities.Catalog.Member", "Caller")
                        .WithMany()
            ...
            modelBuilder.Entity("FlexMoney.Domain.Entities.ExtendedAttributes.DocumentExtendedAttribute", b =>
                {
                    b.HasOne("FlexMoney.Domain.Entities.Misc.Document", "Entity")
            ...
            modelBuilder.Entity("FlexMoney.Domain.Entities.Misc.Document", b =>
                {
                    b.HasOne("FlexMoney.Domain.Entities.Misc.DocumentType", "DocumentType")
                        .WithMany()
            ...
            modelBuilder.Entity("FlexMoney.Infrastructure.Models.Identity.BlazorHeroRoleClaim", b =>
                {
                    b.HasOne("FlexMoney.Infrastructure.Models.Identity.BlazorHeroRole", "Role")
                        .WithMany("RoleClaims")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FlexMoney.Infrastructure.Models.Identity.BlazorHeroUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    b.HasOne("FlexMoney.Infrastructure.Models.Identity.BlazorHeroRole", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
