...
using FlexMoney.Application.Features.ExtendedAttributes.Commands.AddEdit;
using FlexMoney.Application.Features.ExtendedAttributes.Commands.Delete;
using FlexMoney.Application.Features.ExtendedAttributes.Queries.Export;
using FlexMoney.Application.Features.ExtendedAttributes.Queries.GetAll;
using FlexMoney.Application.Features.ExtendedAttributes.Queries.GetAllByEntityId;
using FlexMoney.Application.Features.ExtendedAttributes.Queries.GetById;
using FlexMoney.Domain.Contracts;
using Microsoft.AspNetCore.Mvc;

namespace FlexMoney.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
